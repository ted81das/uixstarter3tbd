	...
	public function getFeatures() {
		$features = array(
            ...
            array(
                ...
                'details'     => HMWP_Classes_Tools::getOption( 'hmwp_plugin_website' ) . '/kb/firewall-geo-security/#firewall_script_injection',
                'show'        => true,
            ),
            array(
                ...
                'details'     => HMWP_Classes_Tools::getOption( 'hmwp_plugin_website' ) . '/kb/firewall-geo-security/#country_blocking',
                'show'        => true,
            ),
            array(
			...
			array(
				...
				'details'     => HMWP_Classes_Tools::getOption( 'hmwp_plugin_website' ) . '/kb/firewall-geo-security/#hide_security_headers',
				'show'        => true,
			),
			array(
