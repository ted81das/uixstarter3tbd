	...
	class Autoloader {
		...
		public function __construct() {
			...
			$this->staticMap = array(
				$libraryPrefix . 'PucReadmeParser' => 'update/vendor/PucReadmeParser.php',
				$libraryPrefix . 'Parsedown'       => 'update/vendor/Parsedown.php',
			);
			...
			if ( $versionSeparatorPos !== false ) {
				...
				if ( ($pointPos !== false) && ($pointPos > 1) ) {
					...
					$this->staticMap[$majorVersionNs . '\\PucFactory'] =
						'update/' . $majorVersionSegment . '/Factory.php';
				}
			}
