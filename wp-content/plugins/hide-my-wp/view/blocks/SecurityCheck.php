...
<div class="card col-sm-12 m-0 mb-2 p-0 rounded-0">
    <div class="card-body f-gray-dark text-center">
        ...
        <div class="card-text text-info m-3">
            <a href="<?php echo esc_url(HMWP_Classes_Tools::getSettingsUrl( 'hmwp_securitycheck', true )) ?>" class="btn rounded-0 btn-sidebar text-white px-4 securitycheck"><?php echo esc_html__( 'Security Check', 'hide-my-wp' ); ?></a>
        </div>
