	...
	public static function getAlerts() {
		...
		if ( is_admin() || is_network_admin() ) {
			...
			if ( HMWP_Classes_Tools::isCloudPanel() ) {
				HMWP_Classes_Error::setNotification( sprintf( esc_html__( 'Cloud Panel detected. %sPlease read how to make the plugin compatible with Cloud Panel hosting%s', 'hide-my-wp' ), '<a href="' . HMWP_Classes_Tools::getOption( 'hmwp_plugin_website' ) . '/setup-hide-my-wp-ghost-on-cloud-panel-server/" target="_blank">', '</a>' ) );
			}
